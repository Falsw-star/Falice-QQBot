...
def on_open(ws):
    ...
    if PLATFORMTOKEN:
        ...
        token = "d003b6c251a03919984396e35b5d324b924a2494c3c122c9ad6b56760681dcdd" # 这个是Falsw开发时的token哦
    IDENTIFY = {
        "op": 3,
        "body": {
            "token": token,
...
def request(url, data = data):
    if PLATFORMTOKEN:
        ...
        token = "d003b6c251a03919984396e35b5d324b924a2494c3c122c9ad6b56760681dcdd" # 是Falsw开发时的token呢
    headers = {
